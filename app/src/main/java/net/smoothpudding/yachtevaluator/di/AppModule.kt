...
import net.smoothpudding.yachtevaluator.data.api.EvaluationApi
import net.smoothpudding.yachtevaluator.data.error.ErrorHandler
...
object AppModule {
    ...
    private const val BASE_URL = "https://yacht-evaluator-api-1092304578340.asia-northeast1.run.app"
